package com.module.network.upload;
...
public class UploadFileProgressRequestBody extends RequestBody {
    ...
    private BaseFileUploadObserver<ResponseBody> fileUploadObserver;

    public UploadFileProgressRequestBody(File file, BaseFileUploadObserver<ResponseBody> fileUploadObserver) {
